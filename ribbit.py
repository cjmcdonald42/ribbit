...
[F}rog: One digit in your guess is correct and in the correct position of the secret code. 
  Please note that if you have three Frogs, you win and may lead a victory dance of one lap about the room!
[T]oad: One digit of your guess is present in the secret code, but in the wrong position.
  If you get three Toads, your guess has all the correct digits, but in the wrong places!
...
# Player 2 is the Amphibian-Tamer. Ask their name and their guess.
